...
- Semver release tag:
  - `vMAJOR.MINOR.PATCH` (example: `v0.3.1`)
...
| --- | --- | --- |
| `0.3.x` | `v0.3.1` (or newer `v0.3.x`) | fully supported |
| `0.3.x` | `sha-*` built from `0.3.x` branch | supported for CI/canary |
| `0.3.x` | `branch-*` | non-prod only |
