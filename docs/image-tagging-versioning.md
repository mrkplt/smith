...
- Semver release tag:
  - `vMAJOR.MINOR.PATCH` (example: `v0.6.0`)
...
| --- | --- | --- |
| `0.6.x` | `v0.6.0` (or newer `v0.6.x`) | fully supported |
| `0.6.x` | `sha-*` built from `0.6.x` branch | supported for CI/canary |
| `0.6.x` | `branch-*` | non-prod only |
