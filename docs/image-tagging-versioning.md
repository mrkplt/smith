...
- Semver release tag:
  - `vMAJOR.MINOR.PATCH` (example: `v0.4.1`)
...
| --- | --- | --- |
| `0.4.x` | `v0.4.1` (or newer `v0.4.x`) | fully supported |
| `0.4.x` | `sha-*` built from `0.4.x` branch | supported for CI/canary |
| `0.4.x` | `branch-*` | non-prod only |
