...
type Interface interface {
	...
	PauseLoop(ctx context.Context, loopID string, req api.LoopLifecycleRequest) (map[string]any, error)
	ResumeLoop(ctx context.Context, loopID string, req api.LoopLifecycleRequest) (map[string]any, error)
	CancelLoop(ctx context.Context, loopID string, req api.LoopLifecycleRequest) (map[string]any, error)
	CreateLoopIntervention(ctx context.Context, loopID string, req api.LoopInterventionRequest) (*api.LoopInterventionResponse, error)
	...
	CreateTaskContract(ctx context.Context, req api.TaskContractCreateRequest) (*api.TaskContract, error)
	GetTaskContract(ctx context.Context, taskID string) (*api.TaskContract, error)
	PatchTaskContract(ctx context.Context, taskID string, req api.TaskContractPatchRequest) (*api.TaskContract, error)
	ApproveTaskContract(ctx context.Context, taskID string, req api.TaskContractApproveRequest) (*api.TaskContract, error)
