...
expect_rg "Provider Auth \\(Codex\\)" "console/index.html" "Console renders provider auth panel"
expect_rg "auth-status-refresh" "console/index.html" "Console exposes auth status action"
expect_rg "auth-connect-start" "console/index.html" "Console exposes connect action"
expect_rg "auth-connect-complete" "console/index.html" "Console exposes connect complete action"
expect_rg "auth-reconnect" "console/index.html" "Console exposes reconnect action"
expect_rg "auth-disconnect" "console/index.html" "Console exposes disconnect action"
expect_rg "/v1/auth/codex/status" "console/index.html" "Console queries codex auth status endpoint"
expect_rg "/v1/auth/codex/connect/start" "console/index.html" "Console calls codex auth connect start endpoint"
expect_rg "/v1/auth/codex/connect/complete" "console/index.html" "Console calls codex auth connect complete endpoint"
expect_rg "/v1/auth/codex/disconnect" "console/index.html" "Console calls codex auth disconnect endpoint"
